CodeMirror.defineSimpleMode("registermaschine", {
  ...
  start: [
    ...
    {
      regex: /(\d+)(\s?)(jmp|jez|jnz|jne|jlz|jle|jgz|jge|add|sub|mul|div|lda|ldk|sta|inp|out|hlt)\b(\s?)(\d+)/i,
